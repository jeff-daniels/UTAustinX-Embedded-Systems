...
STyp FSM[10]={
	{0x21,0x02, steady, {goS, waitS, goS, waitS, waitS, waitS, waitS, waitS}},	// goS
	{0x22,0x02, change, {goW, goW, goW, goW, walk, walk, walk, goW}},	// waitS
	{0x0C,0x02, steady, {goW, goW, waitW, waitW, waitW, waitW, waitW, waitW}}, 	// goW
	{0x14,0x02, change, {goS, goS, goS, goS, walk, walk, walk, walk}}, 	// waitW
